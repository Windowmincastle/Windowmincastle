...
|------------------------|-------------------------------------------------------|----------------------|--------------------------------------------------------------------------------------|
| 🎨 Code Painter | 개인 사이드 프로젝트 - **VS Code Marketplace 정식 배포** - 멀티 컬러 하이라이팅 기반의 코드 로직 시각화 및 분석 생산성 도구 | 2026.02 - 2026.02 | [code-painter](https://github.com/Windowmincastle/code-painter) |
