...
|------------------------|-------------------------------------------------------|----------------------|--------------------------------------------------------------------------------------|
| ⚡ High-Traffic Concurrency PoC | 대용량 트래픽 환경에서 Lock부터 Kafka까지, 동시성 병목 해결 PoC | 2026.03 - 2026.03 | [High-Traffic-Concurrency-PoC](https://github.com/Windowmincastle/High-Traffic-Concurrency-PoC) |
